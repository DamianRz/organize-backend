...
var JoinEventService = (function () {
    ...
    JoinEventService.prototype.setUserType = function (jeData) {
        return __awaiter(this, void 0, void 0, function () {
            var joinEvent, ex_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.repository.setUserType(joinEvent)];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, this.repository.delete(idEvent)];
                    case 1: return [2, _a.sent()];
                    case 2:
                        ex_3 = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.repository.getJoinEvents(joinEvent)];
                    case 1: return [2, _a.sent()];
                    case 2:
                        ex_4 = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.repository.getJoinUsers(joinEvent)];
                    case 1: return [2, _a.sent()];
                    case 2:
                        ex_5 = _a.sent();
...
//# sourceMappingURL=JoinEventService.js.map
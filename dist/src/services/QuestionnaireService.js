            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.repository.add(questionnaire)];
                    case 1:
                        addNew = _a.sent();
                        if (!(addNew.statusCode == 200)) return [3, 3];
                        return [4, this.repository.getId(questionnaire)];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, this.repository.delete(idQuestionnaire)];
                    case 1: return [2, _a.sent()];
                    case 2:
                        ex_3 = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, this.repository.deleteRelation(idQuestionnaire)];
                    case 1: return [2, _a.sent()];
                    case 2:
                        ex_4 = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, this.repository.getByIdUser(idUser)];
                    case 1: return [2, _a.sent()];
                    case 2:
                        ex_5 = _a.sent();

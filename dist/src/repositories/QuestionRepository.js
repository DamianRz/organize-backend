...
var QuestionRepository = (function () {
    ...
    QuestionRepository.prototype.add = function (q) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.queryFunctions.action(this.queries.getQuery('question', 'add'), data)];
            });
        });
    };
    QuestionRepository.prototype.save = function (q) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.queryFunctions.action(this.queries.getQuery('question', 'save'), data)];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data = [idType];
                        return [4, this.queryFunctions.get(this.queries.getQuery('question', 'getByIdType'), data)];
                    case 1:
                        rows = _a.sent();
    ...
    QuestionRepository.prototype.getId = function (q) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                data = [q.idType, q.name, q.category];
                return [2, this.queryFunctions.get(this.queries.getQuery('question', 'getId'), data)];
            });
        });
    };
    QuestionRepository.prototype.delete = function (idQuestion) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                data = [idQuestion];
                return [2, this.queryFunctions.action(this.queries.getQuery('question', 'delete'), data)];
            });
        });
    };

    ...
    JoinEventRepository.prototype.add = function (o) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.queryFunctions.action(this.queries.getQuery('option', 'add'), data)];
            });
        });
    };
    JoinEventRepository.prototype.linkQuestionnaire = function (idOption, idQuestionnaire) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.queryFunctions.action(this.queries.getQuery('option', 'link'), data)];
            });
        });
    };
    JoinEventRepository.prototype.save = function (o) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.queryFunctions.action(this.queries.getQuery('option', 'save'), data)];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data = [idUser];
                        return [4, this.queryFunctions.get(this.queries.getQuery('option', 'getByIdUser'), data)];
                    case 1:
                        rows = _a.sent();
                        if (rows.statusCode === 200) {
                            ...
                            return [2, new ResultObject_1.default(200, oList_1)];
                        }
                        else {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.queryFunctions.get(this.queries.getQuery('option', 'getIdByIdQuestionnaire'), data)];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.queryFunctions.get(this.queries.getQuery('option', 'getId'), data)];
                    case 1: return [2, _a.sent()];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data = [idOption];
                        return [4, this.queryFunctions.action(this.queries.getQuery('option', 'delete'), data)];
                    case 1: return [2, _a.sent()];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data = [idOption];
                        return [4, this.queryFunctions.action(this.queries.getQuery('option', 'deleteRelation'), data)];
                    case 1: return [2, _a.sent()];
                }
            });
        });

...
var QuestionnaireRepository = /** @class */ (function () {
    ...
    QuestionnaireRepository.prototype.add = function (q) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.queryFunctions.action(this.queries.getQuery('questionnaire', 'add'), data)];
            });
        });
    };
    // save
    QuestionnaireRepository.prototype.save = function (q) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.queryFunctions.action(this.queries.getQuery('questionnaire', 'save'), data)];
            });
        });
    };
    // getByIdUser
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.queryFunctions.get(this.queries.getQuery('questionnaire', 'getByIdUser'), data)];
                    case 1:
                        rows = _a.sent();
                        if (rows.statusCode) {
    ...
    QuestionnaireRepository.prototype.getId = function (q) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                data = [q.idUser, q.name, q.category];
                return [2 /*return*/, this.queryFunctions.get(this.queries.getQuery('questionnaire', 'getId'), data)];
            });
        });
    };
    // delete
    QuestionnaireRepository.prototype.delete = function (idQuestionnaire) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                data = [idQuestionnaire];
                return [2 /*return*/, this.queryFunctions.action(this.queries.getQuery('questionnaire', 'delete'), data)];
            });
        });
    };
    // delete relation
    QuestionnaireRepository.prototype.deleteRelation = function (idQuestionnaire) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                data = [idQuestionnaire];
                return [2 /*return*/, this.queryFunctions.action(this.queries.getQuery('questionnaire', ' deleteRelation'), data)];
            });
        });
    };

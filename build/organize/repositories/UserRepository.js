...
var UserRepository = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, new ResultObject_1.default(200, "userSystem " + user.username + " created")];
                    case 2:
                        ex_3 = _a.sent();
    ...
    //addNewUser
    UserRepository.prototype.addNewUser = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var data_3, ex_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        data_3 = [id];
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                MysqlConnection_1.default.mysqlConn.query("INSERT INTO organize.user values(?);", data_3, function (err, result) {
                                    if (!err)
                                        resolve(result);
                                    else
                                        reject();
                    ...
                    case 1:
                        _a.sent();
                        console.log("crea");
                        return [2 /*return*/, new ResultObject_1.default(200, "user created")];
                    case 2:
                        ex_4 = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        data_4 = [user.username, user.password, user.email, user.id];
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                MysqlConnection_1.default.mysqlConn.query("update organize.usersystem set username=?, password=?, email=? where id=?;", data_4, function (err, result) {
                                    if (!err)
                                        resolve(result);
                                    else
                                        reject();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        data_5 = [id];
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                MysqlConnection_1.default.mysqlConn.query("DELETE FROM organize.usersystem where id=?;", data_5, function (err, result) {
                                    if (!err)
                                        resolve(result);
                                    else
                                        reject();
                    ...
                    case 2:
                        ex_7 = _a.sent();
                        return [2 /*return*/, new ResultObject_1.default(500, { "error": String(ex_7) })];
                    case 3: return [2 /*return*/];
                }
            });
        });

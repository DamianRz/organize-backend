...
var UserRepository = /** @class */ (function () {
    ...
    UserRepository.prototype.get = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                data = [email, password];
                return [2 /*return*/, this.queryFunctions.get(this.queries.getQuery('userSystem', 'get'), data)];
            });
        });
    };
    // existsEmail
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data = [email];
                        return [4 /*yield*/, this.queryFunctions.get(this.queries.getQuery('userSystem', 'existsEmail'), data)];
                    case 1:
                        exists = _a.sent();
                        if (exists.statusCode === 200) {
                            ...
                            return [2 /*return*/, new ResultObject_1.default(403, exists.value)];
                        }
                        return [2 /*return*/];
                }
            });
    ...
    UserRepository.prototype.add = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.queryFunctions.action(this.queries.getQuery('userSystem', 'add'), data)];
            });
        });
    };
    // getIdByEmail
    UserRepository.prototype.getIdByEmail = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                data = [email];
                return [2 /*return*/, this.queryFunctions.get(this.queries.getQuery('userSystem', 'getIdByEmail'), data)];
            });
        });
    };
    // save
    UserRepository.prototype.save = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                data = [user.username, user.password, user.email, user.id];
                return [2 /*return*/, this.queryFunctions.action(this.queries.getQuery('userSystem', 'save'), data)];
            });
        });
    };
    // delete
    UserRepository.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                data = [id];
                return [2 /*return*/, this.queryFunctions.action(this.queries.getQuery('userSystem', 'delete'), data)];
            });
        });
    };
...
//# sourceMappingURL=UserSystemRepository.js.map
...
var JoinEventRepository = /** @class */ (function () {
    ...
    JoinEventRepository.prototype.add = function (je) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.queryFunctions.action(this.queries.getQuery('joinEvent', 'add'), data)];
            });
        });
    };
    // setUserType
    JoinEventRepository.prototype.setUserType = function (je) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.queryFunctions.action(this.queries.getQuery('joinEvent', 'setUserType'), data)];
            });
        });
    };
    // delete
    JoinEventRepository.prototype.delete = function (idEvent) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                data = [idEvent];
                return [2 /*return*/, this.queryFunctions.action(this.queries.getQuery('joinEvent', 'delete'), data)];
            });
        });
    };
    // getJoinUsers
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.queryFunctions.get(this.queries.getQuery('joinEvent', 'getJoinUsers'), data)];
                    case 1:
                        rows = _a.sent();
                        if (rows.statusCode === 200) {
                            ...
                            return [2 /*return*/, new ResultObject_1.default(rows.statusCode, rows.value)]; // error
                        }
                        return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.queryFunctions.get(this.queries.getQuery('joinEvent', 'getJoinEvents'), data)];
                    case 1:
                        rows = _a.sent();
                        if (rows.statusCode === 200) {
                            ...
                            return [2 /*return*/, new ResultObject_1.default(rows.statusCode, rows)]; // error
                        }
                        return [2 /*return*/];
                }
            });

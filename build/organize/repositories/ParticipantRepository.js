...
var JoinEventRepository = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ex_1 = _a.sent();
                        return [2 /*return*/, new ResultObject_1.default(500, { "error 1": String(ex_1) })];
    ...
    //delete
    JoinEventRepository.prototype.delete = function (je) {
        return __awaiter(this, void 0, void 0, function () {
            var data_2, ex_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        data_2 = [je.idUser, je.idEvent];
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                MysqlConnection_1.default.mysqlConn.query("DELETE FROM organize.joinevent WHERE idUser=? AND idEvent=?;", data_2, function (err, result) {
                                    if (!err)
                                        resolve(result);
                                    else
                                        reject();

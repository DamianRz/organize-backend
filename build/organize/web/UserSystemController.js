...
var UserSystemController = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        userData = body.user;
                        return [4 /*yield*/, this.service.signIn(userData.email, userData.password)];
                    case 1:
                        result = _a.sent();
    ...
    // save
    UserSystemController.prototype.save = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var body, requiredObjects, userData, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    // delete
    UserSystemController.prototype.delete = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var body, requiredObjects, userData, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!this.utils.validation(body, requiredObjects, response)) return [3 /*break*/, 2];
                        userData = body.user;
                        return [4 /*yield*/, this.service.delete(userData.id)];
                    case 1:
                        result = _a.sent();
                        response.status(result.statusCode).send(result.value);
                        _a.label = 2;
...
//# sourceMappingURL=UserSystemController.js.map
...
var QueryFunctions = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, new ResultObject_1.default(200, 'sucess ' + query.action + ' in table' + query.table)];
                    case 2:
                        ex_1 = _a.sent();
                        return [2 /*return*/, new ResultObject_1.default(403, { 'Error ': 'table ' + query.table + ' - action ' + query.action + ' :' + String(ex_1) })];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        rows = _a.sent();
                        return [2 /*return*/, new ResultObject_1.default(200, rows)];
                    case 2:
                        ex_2 = _a.sent();
                        return [2 /*return*/, new ResultObject_1.default(403, { 'Error ': 'table ' + query.table + ' - action ' + query.action + ' :' + String(ex_2) })];
                    case 3: return [2 /*return*/];
                }
            });
        });

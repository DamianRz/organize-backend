            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.repository.add(event_1)];
                    case 1:
                        addNewEvent = _a.sent();
                        if (!(addNewEvent.statusCode == 200)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.repository.getId(event_1.name, event_1.created)];
                    case 2: 
                    // Get id by new event
                    return [2 /*return*/, _a.sent()];
                    case 3: return [2 /*return*/, addNewEvent]; // error
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.repository.save(event_2)];
            ...
            return __generator(this, function (_a) {
                try {
                    options.map(function (option) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.repository.linkQuestionnaire(idEvent, idQuestionnaire, option.idOption)];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
                    ...
                    return [2 /*return*/, new ResultObject_1.default(201, 'event linked with questionnaire')];
                }
                catch (ex) {
                    return [2 /*return*/, new ResultObject_1.default(400, { error: String(ex) })];
                }
                return [2 /*return*/];
            });
        });
